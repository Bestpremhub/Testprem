...
Closed.Image = "rbxassetid://16587996851"
...
game:GetService("Players").LocalPlayer.Idled:connect(function()
    ...
    _G.Color = Color3.fromRGB(255,20,147,1)
    ...
    function library:AddWindow(text,keybind)
        ...
        Main.BackgroundColor3 = Color3.fromRGB(255,20,147,1)
        ...
        Top.Name = "Top"
        Top.Parent = Main
        Top.BackgroundColor3 = Color3.fromRGB(255,20,147,1)
        ...
        Page.Name = "Page"
        Page.Parent = Main
        Page.BackgroundColor3 = Color3.fromRGB(255,20,147,1)
        ...
        NameHub.Parent = Page
        NameHub.BackgroundColor3 = Color3.fromRGB(255,20,147,1)
        NameHub.BackgroundTransparency = 1.000
        NameHub.Position = UDim2.new(0.113333493, 0, 0, 0)
        NameHub.Size = UDim2.new(0, 110, 0, 20)
        NameHub.Font = Enum.Font.GothamSemibold
        NameHub.Text = text
        NameHub.TextColor3 = Color3.fromRGB(255,20,147,1)
        ...
        User.Name = "User"
        User.Parent = Page
        User.BackgroundColor3 = Color3.fromRGB(255,20,147,1)
        ...
        UserText.BackgroundColor3 = Color3.fromRGB(255,20,147,1)
            ...
            while wait() do
                pcall(function()
                    ...
                    game:GetService('TweenService'):Create(
                        ...
                        {TextColor3 = Color3.fromRGB(255,20,147,1)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
                        UserText,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
...
---------------------------------------------------------------------------Create Tab
local SOMEXHUB = library:AddWindow("BEST HUB [ PREMIUM ]",Enum.KeyCode.RightControl)
...
if World1 then
    Main:AddToggle" Kaitun Vip ",_G.AutoFarmFast,function(value)
        _G.Farmfast = value
